...
namespace FoundationFortune.Commands.FortuneAdminCommands.AdminCommands.DatabaseCommands
{
        ...
        public bool Execute(ArraySegment<string> args, ICommandSender sender, out string response)
        {
            ...
            switch (addmoneytarget)
            {
                case "self":
                    ...
                    FoundationFortune.Instance.HintSystem.EnqueueHint(ply, $"{selfAddMoney}");
                ...
                case "all":
                    ...
                    {
                        FoundationFortune.Instance.HintSystem.EnqueueHint(player, $"{allAddMoney}");
                ...
                default:
                    ...
                    if (targetPlayer != null) FoundationFortune.Instance.HintSystem.EnqueueHint(targetPlayer, $"{steamIDAddMoney}");
