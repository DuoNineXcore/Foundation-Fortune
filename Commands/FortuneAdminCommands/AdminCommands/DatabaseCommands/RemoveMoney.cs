            ...
            if (args.Count >= 3)
            {
                ...
                switch (target)
                {
                    case "self":
                        ...
                        FoundationFortune.Instance.HintSystem.EnqueueHint(ply, $"{selfRemoveMoney}");
                    ...
                    case "all":
                        if (subtractSaved)
                        {
                            ...
                            foreach (var player in Player.List)
                            {
                                ...
                                FoundationFortune.Instance.HintSystem.EnqueueHint(player, $"{allRemoveMoney}");
                    ...
                    default:
                    {
                        ...
                        if (targetPlayer != null)
                        {
                            ...
                            FoundationFortune.Instance.HintSystem.EnqueueHint(targetPlayer, $"{steamIdRemoveMoney}");
                        }
                    }
