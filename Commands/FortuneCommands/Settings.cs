...
namespace FoundationFortune.Commands.FortuneCommands
{
    ...
    internal class Settings : ICommand,IUsageProvider
    {
        ...
        public string[] Usage { get; } = new string[] { 
            ...
            "<activeabilityconfirmationtime> <0-20>   \n",
        ...
        private static bool GetProperty(Player player, string property, out string response)
        {
            switch (property.ToLowerInvariant())
            {
                ...
                case "hintageseconds": response = $"HintAgeSeconds is set to {PlayerDataRepository.GetHintAgeSeconds(player.UserId)}";
                    return true;
               // case "hintanim": response = $"HintAnim is set to {PlayerDataRepository.GetHintAnim(player.UserId)}";
               //     return true;
        ...
        private static string ListCommands()
        {
            ...
            //commandList.AppendLine("ff_settings set hintanim <right/left/center> - Set your hint animation.");
        ...
        /*
        private static bool SetHintAnim(ArraySegment<string> args, Player player, out string response)
        {
