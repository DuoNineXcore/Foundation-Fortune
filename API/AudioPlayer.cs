...
namespace FoundationFortune.API
{
    ...
    public static class AudioPlayer
    {
        ...
        public static PlayerVoiceChatSettings GetVoiceChatSettings(PlayerVoiceChatUsageType usageType)
        {
            if (FoundationFortune.VoiceChatSettings?.PlayerVoiceChatSettings != null)
            {
                return FoundationFortune.VoiceChatSettings.PlayerVoiceChatSettings
                    .FirstOrDefault(settings => settings.VoiceChatUsageType == usageType);
            }
    
            // Handle the case where FoundationFortune.Singleton, VoiceChatSettings, or PlayerVoiceChatSettings is null
            return null;
        }
        ...
        public static NPCVoiceChatSettings GetVoiceChatSettings(NpcVoiceChatUsageType usageType)
        {
            if (FoundationFortune.VoiceChatSettings?.NPCVoiceChatSettings != null)
            {
                return FoundationFortune.VoiceChatSettings?.NPCVoiceChatSettings
                    .FirstOrDefault(settings => settings.VoiceChatUsageType == usageType);
            }

            // Handle the case where FoundationFortune.Singleton, VoiceChatSettings, or NPCVoiceChatSettings is null
            return null;
        }
    }
}
