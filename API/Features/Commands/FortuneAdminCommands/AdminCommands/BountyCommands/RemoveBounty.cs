...
namespace FoundationFortune.API.Features.Commands.FortuneAdminCommands.AdminCommands.BountyCommands
{
    ...
    internal class RemoveBounty : ICommand
    {
        ...
        public bool Execute(ArraySegment<string> args, ICommandSender sender, out string response)
        {
            ...
            var bountiedPlayer = BountySystem.BountiedPlayers.FirstOrDefault(bounty => bounty.Player == player && bounty.IsBountied);
            if (bountiedPlayer != null)
            {
                BountySystem.StopBounty(player);
