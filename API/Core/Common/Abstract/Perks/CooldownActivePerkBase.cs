...
public abstract class CooldownActivePerkBase : ICooldownActivePerk
{
    public abstract PerkType PerkType { get; }
    public abstract string Alias { get; }
    public abstract TimeSpan Duration { get; protected set; }
    public abstract TimeSpan Cooldown { get; protected set; }
    public abstract DateTime LastActivationTime { get; set; }
    public abstract bool IsCurrentlyActive { get; set; }
