...
public class VoiceChatSettings : IFoundationFortuneConfig
{
	...
	public List<PlayerVoiceChatSettings> PlayerVoiceChatSettings { get; set; } = new List<PlayerVoiceChatSettings>()
	{
		...
		new PlayerVoiceChatSettings { VoiceChatUsageType = PlayerVoiceChatUsageType.BlissfulAgony, VoiceChat = VoiceChatChannel.Mimicry, Loop = false, AudioFile = "PlayerVoiceChatUsageType\\BlissfulAgony.ogg", Volume = 50 },
